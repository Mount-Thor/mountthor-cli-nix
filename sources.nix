...
# this file. If you do need to bump it manually:
#   1. Set `version` to the per-platform latest (macOS and Linux move in
#      lockstep on each release, so one version covers all three platforms).
